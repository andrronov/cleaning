              ...
              <form class="w-full mb-32">
               ...
               <div class="max-w-7xl mx-auto flex flex-col">
                 <p v-if="form.typesCleaning.selected === 'После строительства'" class="text-red-800">Доставка оборудования в пределах МКАД - 1000 руб.
                  ...
                  <div class="flex flex-row items-center gap-5 sm:gap-10 mb-8">
                     <div class="flex flex-col w-1/2 items-start gap-4">
                        ...
                        <div class="w-full">
                          <label class="block mb-2 text-sm sm:text-lg font-medium text-gray-900 dark:text-white">Площадь (кв/м)</label>
                          <div class="relative flex w-full sm:w-1/2 items-center">
                              <input type="number" v-model="form.cleaningInfo.areaCount" class="bg-gray-50 border border-gray-300 rounded-lg font-medium text-center h-10 text-gray-900 text-lg focus:ring-orange-500 focus:border-orange-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" required />
                     ...
                     <div class="flex w-1/2 flex-col items-start gap-4">
                        ...
                        <label class="block mb-px text-sm sm:text-lg font-medium text-gray-900 dark:text-white">Санузлов</label>
                          <div class="relative flex items-center">
                              ...
                              <input type="number" id="bedrooms-input" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 rounded-lg h-full font-medium text-center text-gray-900 text-lg focus:ring-orange-500 focus:border-orange-500 block w-full py-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" placeholder="" :value="form.cleaningInfo.washRooms" required />
                 ...
                 <div class="flex flex-col w-full min-h-64 justify-around items-center border-2 bg-dev-50 border-dev-500 text-black p-2 rounded-xl mt-8">
                  <p class="text-center text-2xl sm:text-3xl font-semibold">Уборка {{form.typesCleaning.selected}}</p>
                  <span class="text-sm text-gray-700 mb-4 mt-1 text-center" v-if="form.typesCleaning.selected === 'После арендатора'">Итоговая стоимость зависит от степени загрязнения</span>
                  <div class="flex flex-row justify-around w-full px-2">
                    <div class="self-center flex flex-col w-full max-w-80 items-start gap-2">
                    ...
                    <div class="bg-dev-500 text-white flex flex-col justify-between p-2 items-center w-1/3 sm:w-1/4 rounded-xl">
                      ...
                      <defButton @click="sendForm" type="submit" class="border-2 px-5 border-white rounded-xl">Заказать</defButton>
                    </div>
                  </div>
                 </div>
               </div>
...
const form = reactive({
  ...
  typesCleaning: {
    ...
    array: ['Поддерживающая', 'Генеральная', 'После строительства', 'После арендатора']
  },
  additional: {
    selected: [],
    array: [
