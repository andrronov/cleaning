...
const prices = {
   ...
   secondColumn: [
      ...
      }, {name:'Здоровый питомец', price:'+40% к стоимости'}, {name:'Генеральная уборка Санузла', price:'6500р'}, {name:'Генеральная уборка Кухни (all inclusive)', price:'7500р'}, {name:'Генеральная уборка Кухни (без техники)', price:'6500р'}, {name:'Москитная сетка 1шт', price:'200р'}, {name:'Балконный блок (дверь с окном)', price:'1500р'}, {name:'Ковер, ковр. покрытие (химч)', price:'300р/кв.м'}, {name:'Стула без тканевой спинки (химч)', price:'от 300р'}, {name:'Стул с тканевой спинкой (химч)', price:'от 400 р'}, {name:'Подушка (химч)', price:'200р'}, {name:'Пуфик (химч)', price:'500р'}, {name:'Люстра', price:'500р'}, {name:'Хрустальная люстра', price:'800р'}, {name: 'Шторы (постирать, погладить)', price: '500р/шт'}, {name:'*Доставка оборудования по Москве(в область)', price:'от 2500р (от 3500р)'}, {name:'*Подтверждение заказа принимается', price:'до 18.00'}, {name: '*Если клинеры заканчивают уборку после 12 часов ночи дорогу оплачивает клиент(такси).', price: ''}
   ]
}
