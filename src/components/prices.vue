   ...
   firstColumn: [
      {
         ...
         price: '500р.(700р)'
      }, {name:'Холодильник', price:'800р'}, {name:'Духовка(противень+доплата 300р.за шт.)', price:'900р.'}, {name:'Внутри кухонных шкафов', price:'800р/час'}, {name:'Помыть посуду (30 мин)', price:'600р'}, {name:'Посудомоечная машина', price:'750р'}, {name:'Стиральная машина', price:'750р'}, {name:'Внутри микроволновки', price:'700р'}, {name:'Кофемашина', price:'750р'}, {name:'Глажка', price:'1000р/час'}, {name:'Окна (стандартное двухстворчатое окно)', price:'950р'}, {name:'Трехстворчатое окно', price:'1250р'}, {name:'Окна на балконе (1 створка)', price:'750р'}, {name:'Панорамное остекление', price:'550 р/м2'}, {name:'Двойные деревянные окна - цена удваивается', price:'х2'}, {name:'Балкон (уборка без мытья окон)', price:'1000р'}, {name:'Почистить жалюзи 1шт', price:'от 400р'}, {name:'Люстра', price:'500р'}, {name:'Хрустальная люстра', price:'800р'}, {name:'Доп. санузел (генер.уборка)', price:'1500р'}, {name:'Доп. санузел', price:'1500р'}, {name:'*В поддерживающую уборку входит только 1 санузел', price:'50р/м2'}, {name: '*Поддерживающая уборка квартиры свыше 100м2', price: '35р/м2'}
   ],
   secondColumn: [
      {
         name: 'Здоровый малыш',
         price: '+40% к стоимости'
      }, {name:'Здоровый питомец', price:'+40% к стоимости'}, {name:'Генеральная уборка Санузла', price:'6500р'}, {name:'Генеральная уборка Кухни (all inclusive)', price:'7500р'}, {name:'Генеральная уборка Кухни (без техники)', price:'6500р'}, {name:'Москитная сетка 1шт', price:'200р'}, {name:'Балконный блок (дверь с окном)', price:'1500р'}, {name:'Ковер, ковр. покрытие (химч)', price:'300р/кв.м'}, {name:'Стула без тканевой спинки (химч)', price:'от 300р'}, {name:'Стул с тканевой спинкой (химч)', price:'от 400 р'}, {name:'Подушка (химч)', price:'200р'}, {name:'Пуфик (химч)', price:'500р'}, {name:'Мойка стиральной машинки', price:'650р'}, {name:'Мойка посудомойки', price:'600р'}, {name:'*Доставка оборудования по Москве(в область)', price:'от 2500р (от 3500р)'}, {name:'*Подтверждение заказа принимается', price:'до 18.00'}, {name: '*Если клинеры заканчивают уборку после 12 часов ночи дорогу оплачивает клиент(такси).', price: ''}
   ]
}
