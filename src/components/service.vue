...
const services = [
   ...
   },
   {
      ...
      howOptional: {
         ...
         text: 'Клининговая компания NaVi предоставляет разные услуги для уборки небольших офисов и крупнейших офисных центров. Каждая из них обладает рядом особенностей и преимуществ, с учетом которых наши клиенты делают выбор:',
         lis: [
            {
